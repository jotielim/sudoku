...
describe('SudokuPuzzle', () => {
  ...
  describe('checkBoard', () => {
    ...
    it('should return true if board is successfully completed', () => {
      puzzle.board = [
        [5, 3, 4, 6, 7, 8, 9, 1, 2],
        [6, 7, 2, 1, 9, 5, 3, 4, 8],
        [1, 9, 8, 3, 4, 2, 5, 6, 7],
      ...
      result = puzzle.checkBoard();
      expect(result).toBe(true);
    });

    it('should return false if board is not completed', () => {
      puzzle.board = [
        [5, 3, 4, 6, 7, 8, 9, 1, 2],
        [6, 7, 2, 1, 9, 5, 3, 4, 8],
        [1, 9, 8, 3, 4, 0, 5, 6, 7], // incomplete
        [8, 5, 9, 7, 6, 1, 4, 2, 3],
        [4, 2, 6, 8, 5, 3, 7, 9, 1],
        [7, 1, 3, 9, 2, 4, 8, 5, 6],
        [9, 6, 1, 5, 3, 7, 2, 8, 4],
  ...
  describe('solve', () => {
    it('should return the solved board', () => {
      const solution = [
        [5, 3, 4, 6, 7, 8, 9, 1, 2],
        [6, 7, 2, 1, 9, 5, 3, 4, 8],
        [1, 9, 8, 3, 4, 2, 5, 6, 7],
      ...
      puzzle.setupBoard();
      expect(puzzle.board).not.toEqual(solution);
